...
struct CKSOTPOTPInsCommRateField
{
	...
	///卖开手续费率
	TKSOTPRatioType	AskOpenRatioByMoney;
	///卖开手续费费
	TKSOTPRatioType	AskOpenRatioByVolume;
	///卖平手续费率
	TKSOTPRatioType	AskCloseRatioByMoney;
	///卖平手续费
	TKSOTPRatioType	AskCloseRatioByVolume;
	///备兑开手续费率
	TKSOTPRatioType	CoverOpenRatioByMoney;
	///备兑开手续费
	TKSOTPRatioType	CoverOpenRatioByVolume;
	///备兑平手续费率
	TKSOTPRatioType	CoverCloseRatioByMoney;
	///备兑平手续费
	TKSOTPRatioType	CoverCloseRatioByVolume;
	///自动执行手续费率
	TKSOTPRatioType	AutoStrikeRatioByMoney;
	///自动执行手续费
	TKSOTPRatioType	AutoStrikeRatioByVolume;
};
